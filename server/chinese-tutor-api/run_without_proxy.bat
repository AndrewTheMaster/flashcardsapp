...
chcp 65001 > nul
echo =================================
echo Chinese Tutor API Server (No Proxy)
echo =================================
...
REM Explicitly disable all proxy settings
set HTTP_PROXY=
set HTTPS_PROXY=
set NO_PROXY=localhost,127.0.0.1,::1,%LOCAL_IP%

echo.
echo *** PROXY-FREE SERVER CONFIGURATION ***
echo.
...
echo - HTTP_PROXY: (disabled)
echo - HTTPS_PROXY: (disabled)
...
echo Starting API Server with NO proxy...
echo Running requests with direct connections to %LM_STUDIO_URL%
